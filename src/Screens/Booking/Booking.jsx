            ...
            {bookings.map((booking) => (
              ...
              >
                ...
                <p className="text-sm flex items-center">
                  <FaUserTie className="mr-1" /> Service:{" "}
                  {booking.selectedProfession}
                </p>
                <p className="text-sm flex items-center">
                ...
                <p className="text-sm flex items-center">
                  ...
                  {moment(booking.date, "HH:mm").format("h:mm A")}
                </p>
                <p className="text-sm font-bold flex items-center">
                  <FaMoneyCheckDollar className="mr-1" /> Price:{" "}
                  <span className="text-green-500">${booking.rate}</span>
                </p>
